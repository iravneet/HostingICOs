...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'Hosting Icos';//change here
    string public constant _mySymbol = 'Hts';//change here
    uint public constant _myinitialSupply =1000000000  ;//leave it
    uint8 public constant _myDecimal = 5;//leave it
